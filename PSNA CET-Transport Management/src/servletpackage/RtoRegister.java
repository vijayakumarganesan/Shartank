...
/**
 * Servlet implementation class RtoRegister
 */
public class RtoRegister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=impl.Rtoregistration(date, busnumber1,description, amount1,amounttype);  
